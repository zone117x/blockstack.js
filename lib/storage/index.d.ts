 ...
 */
export declare function encryptContent(content: string | Buffer | Uint8Array, options?: {
    publicKey?: string;
...
export declare function decryptContent(content: string, options?: {
    privateKey?: string;
}, caller?: UserSession): Promise<string | Uint8Array | Buffer>;
/**
 ...
 * if it failed
 */
export declare function putFile(path: string, content: string | Buffer | Uint8Array | Blob | File, options?: PutFileOptions, caller?: UserSession): Promise<string>;
/**
